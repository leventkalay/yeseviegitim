...
describe('Egitmen Management Component', () => {
  let comp: EgitmenComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EgitmenComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.egitmen?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
