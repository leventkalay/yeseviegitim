...
describe('Takvim Management Component', () => {
  let comp: TakvimComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TakvimComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.takvims?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
