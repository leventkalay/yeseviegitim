...
describe('Duyuru Management Component', () => {
  let comp: DuyuruComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DuyuruComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.duyurus?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
