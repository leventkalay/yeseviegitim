...
describe('Egitim Management Component', () => {
  let comp: EgitimComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EgitimComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.egitims?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
